...
[![PyLint Test Status](https://badges.ansibleguy.net/sw_iredmail.pylint.svg)](https://github.com/ansibleguy/_meta_cicd/blob/latest/templates/usr/local/bin/cicd/pylint.sh.j2)
